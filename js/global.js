...
var Global = {
    ...
    translations: {
        ...
        en: {
            ...
            'contact_robotics': 'Dedicated to full-stack deep learning applications in intelligent robotics:',
            'about_timeline_1': 'Admitted to the School of Traffic and Transportation Engineering, <strong>Central South University</strong>, Automation (B.S.). Studied at the High-speed Train Research Center, Ministry of Education. GPA <strong>90.26/100</strong>, Rank <strong>2/59</strong>, recipient of the <strong>National Scholarship</strong>, Special Scholarship, etc., Outstanding Graduate.',
            'about_timeline_2': 'Recommended for admission to <strong>Huazhong University of Science and Technology</strong>, Control Science and Engineering (M.S.). Deepening studies at the Key Lab of Image Processing & Intelligent Control, and the <strong>Intelligent Robot Lab</strong>. GPA <strong>3.63/4</strong>, Academic First-class Scholarship, HUST Merit Student, BYD Scholarship.',
            ...
            'about_reviewer': '<i data-lucide="check-circle" style="vertical-align: -4px; width: 20px; margin-right: 4px;"></i> Reviewer for MEAAC2025, NCAA, <a href=".\\ccdc2025\\ccdcreview.pdf" target="_blank">CCDC2026</a>.',
